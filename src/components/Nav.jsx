      ...
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <div>
          ...
          <ul className='hidden md:flex gap-6'>
            <li className='text-sm'><a href="#projects">Proyectos</a></li>
            <li className='text-sm'><a href="#about">Sobre Nosotros</a></li>
            <li className='text-sm'><a href="#members">Miembros</a></li>
            <li className='text-sm'><a href="#contact">Contacto</a></li>
          </ul>
        </div>
      </div>
