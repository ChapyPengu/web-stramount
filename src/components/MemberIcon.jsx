    ...
    <div className="">
        <div className="flex flex-col gap-1 items-center">
            ...
            <div className="flex gap-3 mt-1">
                <a target="_blank" href={github}><i class="text-xl cursor-pointer fa-brands fa-github"></i></a>
                <a target="_blank" href={linkedin}><i class="text-xl cursor-pointer fa-brands fa-linkedin"></i></a>
            </div>
        </div>
    </div>
  )
